        ...
        methods: {
            async sendContact() {
                try {
                    ...
                    const response = await axios.post('http://e-consultationbe.test/api/contact', data);
...
<template>
    ...
    <div class="mt-24 mx-32">
        <h1 class="text-5xl font-bold text-slate-800"> </h1>
